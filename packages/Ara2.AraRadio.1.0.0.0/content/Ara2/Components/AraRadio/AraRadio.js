...
Ara.AraClass.Add('AraRadio', function (vAppId, vId, ConteinerFather) {
    ...
    this.Events.Click =
    {
        ...
        SetEnabled: function (vValue) {
            ...
            if (vValue && this.PrimeiraAtivacaoEvento != true) {
                $(TmpThis.Obj).bind('contextmenu click', function (e) { TmpThis2.Function(e);  });
    ...
    this.SetChecked = function (vTmp) {
        if (vTmp)
            this.Obj.checked = true;
        else
            this.Obj.checked = false;

        this.ControlVar.SetValueUtm('GetChecked()', this.GetChecked());
    }
    ...
    this.GrupName = null;
    this.SetGrupName = function (vGrupName) {
        this.Obj.name = vGrupName;
    }
    ...
    $(this.Obj).focus(function () { TmpThis.Events.Focus.Function(); })
               .blur(function () { TmpThis.Events.LostFocus.Function(); })
               //.click(function () { TmpThis.Events.Click.Function(); })
               .change(function () { TmpThis.Events.Change.Function(); });


    this.ControlVar = new ClassAraGenVarSend(this);
    this.ControlVar.AddPrototype("GetChecked()");
