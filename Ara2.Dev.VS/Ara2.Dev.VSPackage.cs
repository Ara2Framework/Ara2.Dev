...
namespace Tecnomips.Ara2_Dev_VS
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".AraDesign", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "Ara2.Dev.VS")]
    [ProvideKeyBindingTable(GuidList.guidAra2_Dev_VSEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidAra2_Dev_VSPkgString)]
    public sealed class Ara2_Dev_VSPackage : Package
    {
        /// <summary>
