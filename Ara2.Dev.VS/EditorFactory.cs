...
namespace Tecnomips.Ara2_Dev_VS
{
    ...
    /// </summary>
    [Guid(GuidList.guidAra2_Dev_VSEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private Ara2_Dev_VSPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(Ara2_Dev_VSPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidAra2_Dev_VSEditorFactory;
            pgrfCDW = 0;
